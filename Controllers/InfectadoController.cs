...
namespace MongoApi.Controllers
{
    ...
    public class InfectadoController : ControllerBase
    {
        ...
        public InfectadoController(Data.MongoDbContext mongoDbContext)
        {
            _mongoDbContext = mongoDbContext;
            _infectadosCollection = _mongoDbContext.DB.GetCollection<Infectado>(typeof(Infectado).Name.ToLower());
        }
